<template>
  <au-layout-page class="au_detail_demo">
    <au-layout-page-item>
    ...
    <au-layout-page-item>
      <au-detail :descData="DataSource.descData" :descColumn="descColumn" />
    </au-layout-page-item>
  </au-layout-page>
</template>
...
const DataSource: any = reactive({
  dataList: {
    ...
    stocktakePlanNo: "PD-YX-20250302002",
    workshopId: 301,
    workshopLabel: "压型车间",
    planStocktakeDate: "2025-03-03",
    warehouseId: 1,
    warehouseName: "压型电极仓",
