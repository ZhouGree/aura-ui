...
let state = reactive({
  queryData: {
    userName: "zhouxiaoying", // 登录名
    workshopNum: "W1", // 车间编号
    email: "3039471582@qq.com",
...
const opts = computed(() => {
  return {
    userName: {
      label: "登录名称",
      defaultVal: "zhouxiaoying",
      comp: "el-input"
    },
    email: {
      label: "邮箱",
      defaultVal: "3039471582@qq.com",
      comp: "el-input"
    },
    workshopNum: {
      label: "车间",
    ...
    date2: {
      ...
      labelRender: () => {
        return <label style="color:red">au-date-picker使用</label>
      },
      comp: "au-date-picker",
