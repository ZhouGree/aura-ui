<template>
  <au-adaptive-page
    class="menu_mange"
    tableTitle="操作AuTable取消复选功能"
    ref="AuAdaptivePageDemo"
    isCopy
    :table="table"
...
// 获取ref
const AuAdaptivePageDemo: any = ref(null)
...
// 取消选中
const cancelSelect = () => {
  console.log("取消选中", AuAdaptivePageDemo.value)
  if (state.ids.length > 0) {
    console.log("取消选中222", AuAdaptivePageDemo.value.AuTablePage)
    // 方式一（AuAdaptivePage ref）
    AuAdaptivePageDemo.value.clearSelection()
    // 方式二（AuAdaptivePage ref）
    AuAdaptivePageDemo.value.AuTablePage.clearSelection()
  }
}
