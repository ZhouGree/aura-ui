<template>
  ...
  >
    ...
    <template #footerBtn>
      <el-button type="primary" @click="auAdaptivePageRef.AuQueryConditionPage.checkHandle()"
        >自定义查询</el-button
      >
      <el-button type="danger" @click="auAdaptivePageRef.AuQueryConditionPage.resetHandle()"
        >自定义重置</el-button
      >
    </template>
...
const auAdaptivePageRef: any = ref(null)
