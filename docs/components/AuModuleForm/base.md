...
### AuModuleForm Attributes

---

### 1、简介：基于 AuForm 表单组件及 AuDetail 详情组件的再次封装，使页面可以分模块的方式（可以收缩）展示 form 表单或者详情页面

> AuModuleForm 模块表单/详情组件**代码示例：**

```html
<!-- 第一种 表单形式 -->
<au-module-form title="模块表单组件运用" ref="sourceForm" :formOpts="formOpts" :submit="submit" />
...
### 2、配置参数（Attributes）继承 au-form/au-detail Attributes
