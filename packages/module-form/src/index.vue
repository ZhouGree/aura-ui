<template>
  <div class="au_module_form" :style="{ marginBottom: footer !== null ? '60px' : '' }">
    <div class="scroll_wrap">
      ...
      <!-- 表单页面 -->
      <module-form v-if="handleType === 'edit'" v-bind="$attrs" ref="auForm">
...
import type { AuModuleFormProps } from "@/module-form/src/type"
defineOptions({
  name: "AuModuleForm"
})


const props = withDefaults(defineProps<AuModuleFormProps>(), {
  handleType: "edit",
  isShowHeader: false,
  titleSlot: false,
  isShowBack: false,
