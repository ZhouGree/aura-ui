<template>
  <div class="au-date-picker" ref="DatePicker">
    <el-date-picker
      :type="type"
      v-model="time"
...
import type { AuDatePickerSelfProps as AuDatePickerProps } from "@/date-picker/src/type"
defineOptions({
  name: "AuDatePicker"
})

const props = withDefaults(defineProps<AuDatePickerProps>(), {
  plusTime: false,
  type: "date",
