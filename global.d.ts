...
import AuLayoutPage from './lib/layout-page/src/index.vue'
import AuLayoutPageItem from './lib/layout-page-item/src/index.vue'
import AuQueryCondition from './lib/query-condition/src/index.vue'
import AuTable from './lib/table/src/index.vue'
import AuForm from './lib/form/src/index.vue'
import AuSelect from './lib/select/src/index.vue'
import AuSelectTable from './lib/select-table/src/index.vue'
import AuDetail from './lib/detail/src/index.vue'
import AuButton from './lib/button/src/index.vue'
import AuStepWizard from './lib/step-wizard/src/index.vue'
import AuTimerBtn from './lib/timer-btn/src/index.vue'
import AuModuleForm from './lib/module-form/src/index.vue'
import AuAdaptivePage from './lib/adaptive-page/src/index.vue'
import AuDatePicker from './lib/date-picker/src/index.vue'
import AuCheckbox from './lib/checkbox/src/index.vue'
import AuInput from './lib/input/src/index.vue'
import AuRadio from './lib/radio/src/index.vue'
import AuSelectIcon from './lib/select-icon/src/index.vue'
import AuTabs from './lib/tabs/src/index.vue'
import AuDrawer from './lib/drawer/src/index.vue'
import AuBreadcrumb from './lib/breadcrumb/src/index.vue'
import AuQueryTable from './lib/query-table/src/index.vue'
